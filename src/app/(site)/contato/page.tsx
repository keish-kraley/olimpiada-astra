        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center gap-6">
            {socialLinks.map((social) => (
              ...
              >
                <svg className={`h-6 w-6 ${social.color}`} fill="currentColor" viewBox="0 0 24 24">
                  {social.icon}
                </svg>
